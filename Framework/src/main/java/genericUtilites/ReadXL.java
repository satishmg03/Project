...
public class ReadXL implements IAutoConstant{
	
	@DataProvider(name = "testdata")
	public static Object[][] readMultipleData() throws EncryptedDocumentException, InvalidFormatException, IOException {
